...
class Aplicacion:
	def __init__(self):
		...
		self.coronel_sanders_list = [[455,478],[470,445],[450,445],[450,435],[460,435],[460,430],[440,400],[430,375],[425,370],[425,355],[425,345],[420,345],[420,335],[418,333],[418,325],[425,322],[425,317],[420,314],[424,310],[435,310],[434,305],[426,302],[437,301],[444,296],[444,291],[448,290],[448,288],[452,288],[453,285],[462,285],[464,283],[484,283],[483,285],[494,286],[520,310],[520,320],[525,320],[525,375],[516,385],[510,385],[510,400],[505,400],[505,410],[490,425],[485,425],[485,430],[496,433],[495,443],[478,443],[478,455],[480,455],[480,477],[475,475],[475,457],[470,458],[468,478]]
		
								#Pollo1																															#Pollo4																												#Pollo3	mal																Pollo2
		self.chicken_1_list = [[295,220],[297,207],[298,198],[300,195],[300,190],[325,170],[330,168],[342,168],[344,172],[358,170],[358,177],[374,181],     [376,164],[375,183],[375,165],[392,148],[396,146],[410,145],[410,146],[418,152],[430,145],[450,146],[450,155],           [449,157],[435,156],[431,156], [418,162],[380,200],[375,219], 	      [375,220],[385,220],[395,202],[405,191],[425,189],[432,190],[449,205], [448,217],[444,221]      ,[375,220],[376,218],[387,217],[404,191],[432,190],[447,202],[448,218],[443,222],              [432,189],[475,140],[503,135],[545,145],[557,157],[573,180],   [485,222],[488,215],[510,196],[584,180],[587,183],[595,183],[600,175],[612,177],[623,190],[619,206],[600,221],   	[616,175],[640,153],[658,152],[675,169],[678,175],[677,188],[662,201],[659,212],[654,221]]							
	...
	def chicken1(self):
		...
		for i in range(0,len(self.chicken_1_list)-1):
			group_chicken_1.append(self.create_l(self.chicken_1_list[i],self.chicken_1_list[i+1]))
	...
	def coronel_sanders(self):
		...
		for i in range(0,55):
			group_coronel_sanders.append(self.create_l(self.coronel_sanders_list[i],self.coronel_sanders_list[i+1]))
		group_coronel_sanders.append(self.create_l(self.coronel_sanders_list[55],self.coronel_sanders_list[0]))
